...
function start(){if(!login||login.classList.contains('hidden')||document.hidden)return;if(!title)title=script('js/race-title.js?v=apex-bank-alignment-4').catch(()=>{title=null;});}
