...
(function(root){'use strict';
 ...
 function create(){
  ...
  function circuit(track){
   ...
   const middle=points[Math.floor(n/2)];const groundMesh=box(group,track.open?middle.x:0,-.6,track.open?middle.z:0,3200,1,3200,theme.ground);groundMesh.receiveShadow=true;
   if(gen3&&pack()){
